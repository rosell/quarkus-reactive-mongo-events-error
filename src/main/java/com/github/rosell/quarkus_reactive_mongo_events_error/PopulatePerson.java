...
public class PopulatePerson {
   ...
   */
  public static final String POPULATE_CHANNEL = "populate-person";
  ...
  /**
   * The repository to consult.
   */
  @Inject()
  PersonRepository repository;

  /**
   * Called when the quarkus is started to start to fill in with {@link Person}.
   *
  ...
  public void createPerson(final Integer count) {
    ...
    this.repository.persist(person).onFailure().invoke(error -> {
